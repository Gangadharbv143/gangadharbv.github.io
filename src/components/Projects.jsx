    ...
    <section className="py-20 bg-gray-950 text-white text-center">
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto px-6">
        ...
        <div className="bg-gray-900 p-6 rounded-xl shadow-lg">
          ...
          <p className="mb-4">
            Implemented Kubernetes Persistent Volumes (PV) and Persistent Volume Claims (PVC).
            Demonstrated persistent storage by storing data that remained available even after pod deletion and recreation.
          </p>

          <a
            href="https://github.com/Gangadharbv143/kubernetes-storage-project"
            target="_blank"
            rel="noreferrer"
            className="text-cyan-400"
          >
